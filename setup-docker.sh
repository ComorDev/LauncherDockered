...
cp -r src/LaunchServer/build/libs/libraries ./libraries;
cp -r src/LaunchServer/build/libs/proguard ./proguard;
...
cp -r src/javaargs.txt javaargs.txt
cp -r src/java24args.txt java24args.txt
mkdir modules;
